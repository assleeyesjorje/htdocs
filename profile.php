        ...
        <div class="col-sm-8">
            <?php
                ...
                <div>
                    ...
                    <ul class='nav pull-left' style='position:absolute;top:10px;left:40px;'>
                        <li class='dropdown'>
                            <button id='change-cover' class='dropdown-toggle btn btn-default' data-toggle='dropdown'>Change Cover</button>
                            <div class='dropdown-menu'>
                                <center>
                                <p>Click <strong>Select Cover</strong> and then click the <br> <strong>Update Cover</strong></p>
                                <label class='btn btn-info' id='select-cover'> Select Cover
                                <input type='file' name='u_cover' size='60' />
                                </label><br><br>
                                <button id='update-cover' name='submit' class='btn btn-info'>Update Cover</button>
                                </center>
                            </div>
                        </li>
                    </ul>
            ...
            <?php 
                if(isset($_POST['submit'])) {
                    ...
                    if($u_cover == '') {
                        ...
                        $update = "update users2 set user_cover='$u_cover.$random_number' where user_id='$user_id'";
                        $run = mysqli_query($con, $update);
                        
                        if($run) {
                            echo "<script>alert('Cover Updated')</script>";
                            echo "<script>window.open('profile.php?u_id =$user_id', '_self')</script>";
                        }
                    }
                }
            ...
            <?php
                if(isset($_POST['update'])) {
                    ...
                    $pfp_temp = $_FILES['u_image']['tmp_name'];
                    $random_number = rand(1, 1000000);
                    ...
                    if($u_image == '') {
                        ...
                        move_uploaded_file($pfp_temp, "users/$u_image.$random_number");
                        $update = "update users2 set user_image='$u_image.$random_number' where user_id='$user_id'";
                        $run = mysqli_query($con, $update);
    ...
    <div class="row">
        ...
        <div class="col-sm-2" style="background-color: #e6e6e6;text-align: center;left: 0.6%;border-radius: 5px;">
            ...
            echo"
                ...
                <p><strong>Account Origin: </strong> $register_date</p><br>
        ...
        <div class="col-sm-6">
            <?php
                ...
                $get_posts = "select * from posts2 where user_id ='$u_id'";
